...
- **Ikke målt:** rigtig kunde med persona (Charlotte + situationer) og flere målgrupper; computeren (1440); rigtig telefon. `storStart` løfter ikke »é« (»én detalje …« står med lille) — husets funktion, ikke rørt.
